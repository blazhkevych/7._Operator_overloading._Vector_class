...
############################################ ЗАДАНИЕ ###########################################
	...
	При бинарной операции, типа + - * в реализации создавать новый обьект и его возвращать.
	Результирующий вектор должен быть с наибольшей длиной из двух данных векторов.

	+= -= изменяется левый операнд и он же есть результатом.
